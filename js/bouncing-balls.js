(function () {
    ...
    *********************/
    ...
    radiuselement.addEventListener('input', function() {
        ballProperties.radius = parseFloat(radiuselement.value);
    });
    maxspeedelement.addEventListener('input', function() {
        aimProperties.maxSpeed = parseFloat(maxspeedelement.value);
    });
